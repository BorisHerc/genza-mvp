import type { ReviewAuthoredDetails } from '../../types/profile'
import { formatRelativeTime, getCategoryLabel } from '../../lib/utils'
import { useTranslation } from '../../context/LocaleContext'
import { Card } from '../ui/Card'
import { StarRating } from './StarRating'

interface ReviewAuthoredCardProps {
  review: ReviewAuthoredDetails
}

export function ReviewAuthoredCard({ review }: ReviewAuthoredCardProps) {
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-sm font-semibold text-gray-900">
            {t('profile.reviewFor', { name: review.revieweeName })}
          </p>
